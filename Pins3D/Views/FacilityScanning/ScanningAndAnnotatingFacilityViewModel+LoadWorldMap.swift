...
//                    }
                ...
                NotificationCenter.default.post(name: ScanningAndAnnotatingFacilityViewModel.loadWorldMapNotification,
                                                object: self,
                                                userInfo: [ScanningAndAnnotatingFacilityViewModel.worldMapKey: worldMap])
                msg = "Done Loading"
                print(msg)
//                DispatchQueue.main.async {
//                    self.loadingMsg = msg
